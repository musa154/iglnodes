...
if __name__ == '__main__':
    ...
    if activated_key:
        # --- MODIFICATION ---
        # Check if the saved key is the bypass key
        if activated_key == "HACKFREE":
            print("Developer bypass active.")
            activated = True
        # --- END MODIFICATION ---
        else:
            # Original logic
    ...
    if not activated:
        ...
        while True:
            ...
            if new_key == "HACKFREE":
                db.set_setting('activated_license', "HACKFREE")
                print("Activated successfully! (Bypass)")
                activated = True
    ...
    # Only run the server if activation was successful
    if activated:
